// ========================================================
//  EMPIREPICKS GAMES ENGINE (LINES + PROPS + ANALYTICS)
// ========================================================
...
function renderGame(ev, odds) {
  ...
  // ---------- Lines table (moneyline, spread, total, EV) ----------
...
// ========================================================
//  PLAYER PROPS (ANYTIME TD, PASS YDS/TD, RUSH YDS, RECEPTIONS)
// ========================================================
...
// ========================================================
//  EXPORT FOR DASHBOARD (EV TABLE, TOP 5 EDGES, PARLAYS)
// ========================================================
