// teams.js — simple global team assets
...
const TeamAssets = {
  nfl: {
    ...
    "Green Bay Packers":        { abbr: "Green Bay Packers", abbr2: "GB", primary: "#203731", secondary: "#FFB612" },
  ...
  get(name) {
    ...
    return {
      ...
      logoUrl:
        ...
        "&background=" +
        bg +
        "&color=fff&size=64&length=3&rounded=true"
    };
  }
};
